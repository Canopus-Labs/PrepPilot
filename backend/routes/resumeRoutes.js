...
// @access  Private
router.post('/save', protect, generalLimiter, validateSaveResume, saveResume);

// @route   GET /api/resume/my-resumes
// @desc    Get all saved resumes for logged-in user
// @access  Private
router.get('/my-resumes', protect, generalLimiter, getMyResumes);

// @route   DELETE /api/resume/:id
// @desc    Delete a saved resume by ID
// @access  Private
router.delete('/:id', protect, generalLimiter, deleteResume);
