...
const RoleInfoHeader = ({
  ...
  return (
    <div className="relative rounded-2xl p-6 md:p-8 overflow-hidden mb-8 border border-border-color bg-card/60 backdrop-blur-xl shadow-sm dark:shadow-lg">
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-start md:justify-between gap-6">
        <div className="flex-1 min-w-0">
          ...
          {description && (
            <p className="text-sm text-gray-700  mb-5 leading-relaxed max-w-3xl border-l-2 border-violet-500/30 pl-3">
              <span className="font-semibold text-text-primary">Info: </span>{description}
            </p>
          )}
