...
const ResumeTemplates = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-text-primary px-5 md:px-12 py-10 transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 max-w-6xl mx-auto">
        ...
        <button
          ...
          className="group relative flex flex-col items-center justify-center p-6 rounded-xl bg-white dark:bg-[#151c2f] border-2 border-dashed border-border-color hover:border-violet-500/50 dark:hover:border-violet-500/50 hover:bg-gray-50 dark:hover:bg-white/5 transition-all duration-300 text-center min-h-[220px] shadow-sm hover:shadow-md overflow-hidden"
        >
          <div className="w-12 h-12 mb-3 rounded-full bg-surface flex items-center justify-center text-text-muted group-hover:text-violet-600 dark:group-hover:text-violet-400 group-hover:scale-110 group-hover:bg-violet-50 dark:group-hover:bg-violet-900/20 transition-all shadow-sm">
            <Plus size={24} />
          </div>
          <h3 className="text-lg font-bold text-text-primary  mb-1 group-hover:text-violet-700 dark:group-hover:text-violet-300 transition-colors">
            Blank Project
          </h3>
          <p className="text-xs text-text-muted font-medium px-4">
        ...
        {RESUME_TEMPLATES.map((template) => (
          <button
            ...
            className="group relative flex flex-col items-start p-0 rounded-xl bg-white dark:bg-[#151c2f] border border-border-color  hover:border-violet-400 dark:hover:border-violet-500/40 hover:shadow-md transition-all duration-300 text-left overflow-hidden shadow-sm min-h-[220px]"
          >
            {/* Template Cover / Image Simulation */}
            <div className="w-full h-32 bg-gray-50 dark:bg-[#0b1120]/50 shrink-0 relative flex items-center justify-center overflow-hidden border-b border-gray-100">
              ...
              {/* Refined"LaTeX" badge */}
              <div className="absolute top-3 right-3 bg-card border border-border-color px-2 py-0.5 rounded-full flex items-center shadow-sm backdrop-blur-sm">
                <span className="text-[9px] font-bold tracking-wider text-text-muted uppercase">LaTeX</span>
              </div>
            </div>
            
            {/* Info Section */}
            <div className="p-4 flex flex-col flex-1 w-full relative z-10 bg-transparent">
              <h3 className="text-base font-bold text-text-primary mb-1 group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors">
                {template.name}
              </h3>
