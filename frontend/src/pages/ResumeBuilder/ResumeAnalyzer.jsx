...
const ResumeAnalyzer = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center relative group">
        ...
        <div className="relative w-44 h-44 flex items-center justify-center">
          ...
          <div className="absolute flex flex-col items-center justify-center z-20">
            <div className="flex items-start">
              ...
              <span className="text-sm font-bold text-text-muted ml-1 mt-1">%</span>
            </div>
            <span className="text-[10px] font-extrabold uppercase tracking-widest mt-1 text-text-muted">
              {statusId}
            </span>
          </div>
        </div>
        ...
        <div className="mt-6 flex flex-col items-center relative z-20 text-center">
          <span className="text-sm font-extrabold text-text-primary dark:text-gray-100 uppercase tracking-[0.2em]">{label}</span>
          <span className="text-xs font-semibold text-text-muted mt-1">{subtitle}</span>
        </div>
      </div>
    );
  };
  ...
  return (
    <div className="min-h-screen bg-background px-5 py-10 md:px-12 transition-colors duration-300">
        ...
        {!result ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div 
                ...
                className="relative group w-full h-80 flex flex-col items-center justify-center border-2 border-dashed border-border-color dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-400 bg-white dark:bg-[#151c2f] rounded-3xl transition-all duration-300 overflow-hidden shadow-sm hover:shadow-lg"
              >
                <input 
                ...
                <div className="flex flex-col items-center text-center px-6 w-full h-full">
                  <iframe
                    src={previewUrl}
                    className="w-full h-48 rounded-xl border border-border-color shadow-sm mb-3"
                    title="File Preview"
                  />
                  <h3 className="text-sm font-bold text-text-primary line-clamp-1">{file.name}</h3>
            ...
            <div className="flex flex-col justify-center space-y-8 bg-white dark:bg-[#151c2f] border border-border-color  rounded-3xl p-8 shadow-sm">
               
              <div className="space-y-3">
                <label className="text-sm font-bold tracking-wide uppercase text-gray-700  flex items-center gap-2">
                ...
                <input 
                  ...
                  className="w-full bg-gray-50 dark:bg-black/20 border border-border-color rounded-xl px-4 py-3.5 text-text-primary outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all font-medium placeholder-gray-400 dark:placeholder-gray-600"
                />
              </div>
              ...
              <button
                ...
                className={`w-full flex items-center justify-center overflow-hidden gap-3 py-4 rounded-xl font-bold text-base transition-all duration-300 shadow-sm ${
                  !file
                    ?"bg-gray-200 dark:bg-white/5 text-gray-400 dark:text-text-secondary cursor-not-allowed"
                    : isAnalyzing 
          ...
          <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 flex flex-col sm:flex-row items-center justify-around bg-white dark:bg-sidebar rounded-[2.5rem] p-8 md:p-12 border border-border-color  shadow-xl relative overflow-hidden">
                 {/* Decorative vectors */}
              ...
              <div className="bg-white dark:bg-sidebar rounded-[2.5rem] p-8 border border-border-color  shadow-xl flex flex-col justify-center relative overflow-hidden group">
                <div className="absolute -right-8 -bottom-8 opacity-5 dark:opacity-[0.03] text-text-primary transition-transform duration-700 group-hover:scale-110 group-hover:-rotate-6 pointer-events-none">
                  <FileText size={180} />
                </div>
                ...
                <h3 className="text-[11px] font-extrabold uppercase tracking-[0.2em] text-text-muted mb-2 relative z-10">
                  ATS Parse Status
                </h3>
                <div className="relative z-10 space-y-3">
                  ...
                  <p className="text-sm text-text-secondary  font-medium leading-relaxed pr-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               ...
               <div className="space-y-6">
                 {/* Missing Skills */}
                 <div className="bg-white dark:bg-[#151c2f] rounded-3xl p-8 border border-border-color  shadow-sm">
                   ...
                   {result.missingSkills?.length > 0 ? (
                     ...
                     <p className="text-sm text-text-muted font-medium">No critical missing skills detected for this role!</p>
                   )}
                 </div>
                 ...
                 <div className="bg-white dark:bg-[#151c2f] rounded-3xl p-8 border border-border-color  shadow-sm">
                   ...
                   <ul className="space-y-3">
                     {result.missingProjects?.length > 0 ? result.missingProjects.map((proj, i) => (
                       <li key={i} className="flex items-start gap-3 text-sm font-medium text-gray-700  bg-gray-50 dark:bg-white/5 p-3 rounded-xl border border-gray-100">
                         <X size={16} className="text-red-400 shrink-0 mt-0.5" />
                         {proj}
                       </li>
                     )) : (
                       <p className="text-sm text-text-muted font-medium">Your portfolio perfectly matches role expectations.</p>
                     )}
                   </ul>
                 </div>
               </div>
               ...
               {/* Suggestions List */}
               <div className="bg-white dark:bg-[#151c2f] rounded-3xl p-8 border border-border-color  shadow-sm flex flex-col h-full">
                 <h3 className="text-lg font-bold text-text-primary mb-6 flex items-center gap-2">
                 ...
                 <button
                   ...
                   className="mt-8 w-full py-4 rounded-xl border-2 border-dashed border-border-color dark:border-gray-700 text-text-secondary  font-bold hover:bg-gray-50 dark:hover:bg-white/5 hover:border-gray-400 hover:text-text-primary dark:hover:text-white transition-all text-sm uppercase tracking-widest"
                 >
