...
export default function SkillAssessmentComingSoon() {
  return (
    <>
      ...
      <div className="min-h-screen w-full bg-background text-text-primary flex flex-col items-center justify-center px-4 py-10 transition-colors duration-300">
        <div className="relative rounded-xl p-10 max-w-xl w-full text-center bg-purple-50 dark:bg-white/10 backdrop-blur-md border shadow-md border-purple-100 dark:border-white/20 transition-colors duration-300">
          ...
          <h1 className="text-4xl font-bold text-text-primary mb-4 mt-8 transition-colors duration-300">
            Skill Assessment Platform
          </h1>
          <p className="text-lg text-gray-700  mb-6 transition-colors duration-300">
          ...
          <div className="mb-6">
            <ul className="list-disc list-inside text-left text-gray-700  mx-auto max-w-md text-base transition-colors duration-300">
